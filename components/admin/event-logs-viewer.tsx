...
const eventTypeLabels: Record<string, string> = {
  ...
  call_reception_3cx: "3CX reception call",
  ...
  call_no_answer_timeout_mock: "No answer timeout",
...
const filterOptions = [
  ...
  { label: "3CX call requested", value: "call_employee_3cx" },
  { label: "3CX call connected", value: "call_connected_3cx" },
  { label: "3CX call ended", value: "call_ended_3cx" },
  { label: "3CX call cancelled", value: "call_cancelled_3cx" },
  { label: "3CX call failed", value: "call_failed_3cx" },
  { label: "Reception call", value: "call_reception_mock" },
  { label: "3CX reception call", value: "call_reception_3cx" },
  {
    label: "3CX reception connected",
    value: "call_reception_connected_3cx",
  },
  { label: "3CX reception ended", value: "call_reception_ended_3cx" },
  {
    label: "3CX reception cancelled",
    value: "call_reception_cancelled_3cx",
  },
  { label: "3CX reception failed", value: "call_reception_failed_3cx" },
  { label: "No answer timeout", value: "call_no_answer_timeout_mock" },
